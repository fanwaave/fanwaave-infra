# Supabase overlays for fanwaave
...
**`fanwaave`**. Every migration in these overlays must stay inside `fanwaave`; the first migration creates it and
...
- **Authority does not move.** Portable SQL and JSON Schema stay in `fanwaave/fanwaave-lib-core` (lib-core tier).
